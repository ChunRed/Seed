...
//--------------------------get tracker state & ID
                            UI_ctrl.instance.state.text = "state : get tracker : " + _arImg.referenceImage.name;
                            UI_ctrl.instance.tracker = _arImg.referenceImage.name;
                        }
                    }
                    else
                    {
...
//------------------get tracker state & ID
                    UI_ctrl.instance.state.text = "state : lost tracker";
                    UI_ctrl.instance.tracker = "00";
                }
